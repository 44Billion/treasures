...
import { Shield, Upload, AlertTriangle, Sparkles, Crown, Gem, Star, Loader2, Copy, Check, ChevronDown, ChevronUp, Link, ExternalLink } from 'lucide-react';
...
} from '@/features/auth/hooks/useLoginActions';
