    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50/60 via-emerald-50/50 to-teal-50/40 dark:from-slate-900 dark:via-green-950 dark:to-emerald-950 adventure:from-amber-100/80 adventure:via-yellow-50/60 adventure:to-orange-100/70">      <DesktopHeader />
      ...
      <section className="relative py-12 xs:py-16 md:py-20 px-3 xs:px-4 bg-gradient-to-b from-background to-muted/20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none hidden md:block overflow-visible">
          ...
          <div className="absolute top-[43%] w-[150%] -left-[25%] h-56 bg-green-600/20 dark:bg-green-500/25 adventure:bg-yellow-600/25 transform rotate-[4deg] origin-center"></div>
