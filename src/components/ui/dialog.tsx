...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center">
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-2 top-2 z-20 h-8 w-8 rounded-full opacity-70 ring-offset-background transition-all hover:opacity-100 hover:bg-accent focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground flex items-center justify-center sm:right-4 sm:top-4">
          <X className="h-4 w-4" />
