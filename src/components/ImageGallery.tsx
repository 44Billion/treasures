...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-0 z-[100001] grid w-full border bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        className
      )}
      {...props}
    >
  ...
  return (
    <DialogPrimitive.Root open={isOpen} onOpenChange={onClose}>
      <ImageGalleryDialogContent 
        className="w-screen h-screen p-0 bg-black/95 border-0"
